...
<!--<link rel="stylesheet" href="${Context.request.contextPath}/${pageContext.request.contextPath}/${pageContext.request.contextPath}/plugins/timepicker/bootstrap-timepicker.min.css">-->
...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<script>
		function changePageSize() {
			...
			$("#changePageSize").innerText=pageSize;
			//向服务器发送请求，改变没页显示条数
